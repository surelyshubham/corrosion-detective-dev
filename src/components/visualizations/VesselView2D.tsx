...
export type VesselView2DRef = {
  capture: () => string;
};

interface VesselView2DProps {}

export const VesselView2D = forwardRef<VesselView2DRef, VesselView2DProps>((props, ref) => {
...
VesselView2D.displayName = "VesselView2D";
